...
!function (global, setTimeout) {
  ...
  function mixin(e, t, i, r) {
    return t && eachProp(t, function (t, n) {
      !i && hasProp(e, n) ||
        (!r || "object" != typeof t || !t || isArray(t) || isFunction(t) ||
            t instanceof RegExp
          ? e[n] = t
  ...
  function newContext(e) {
    ...
    function i(e, i, r) {
      ...
      if (
        ...
        (c = (e = e.split("/")).length - 1,
          y.nodeIdCompat && jsSuffixRegExp.test(e[c]) &&
        ...
        for (a = (o = e.split("/")).length; a > 0; a -= 1) {
          if (u = o.slice(0, a).join("/"), h) {
            for (s = h.length; s > 0; s -= 1) {
              if (
                (n = getOwn(m, h.slice(0, s).join("/"))) && (n = getOwn(n, u))
              ) {
                d = n, p = a;
                break e;
              }
    ...
    function u(e, t, i) {
      ...
      !hasProp(j, r) || n && !n.defineEmitComplete
        ? (n = s(e)).error && "error" === t ? i(n.error) : n.on(t, i)
        : "defined" === t && i(j[r]);
    }
    function c(e, t) {
            ...
            eachProp(k, function (e) {
              ...
              if (e.enabled && (i.isDefine || s.push(e), !e.error)) {
                if (!e.inited && o) n(c) ? (t = !0, u = !0) : (a.push(c), r(c));
                  ...
                  !e.inited && e.fetched && i.isDefine && (u = !0, !i.prefix)
                ) {
                  return d = !1;
                }
              }
    ...
    return E = {
        ...
        init: function (e, t, i, r) {
          r = r || {},
            this.inited || (this.factory = t,
              i
                ? this.on("error", i)
                : this.events.error && (i = bind(this, function (e) {
                  this.emit("error", e);
                })),
              ...
              if (this.error) this.emit("error", this.error);
                ...
                if (this.defining = !0, this.depCount < 1 && !this.defined) {
                  if (isFunction(o)) {
                    ...
                    if (
                      this.map.isDefine && void 0 === n && ((t = this.module)
                        ? n = t.exports
                        : this.usingExports && (n = this.exports)), e
                    ) {
                      return e.requireMap = this.map,
                        e.requireModules = this.map.isDefine
                          ? [this.map.id]
                          : null,
                        e.requireType = this.map.isDefine ? "define"
                        : "require",
                        c(this.error = e);
                    }
                  } else n = o;
            ...
            u(
              ...
              bind(this, function (r) {
                ...
                return this.map.unnormalized
                  ? (r.normalize && (l = r.normalize(l, function (e) {
                    return i(e, h, !0);
                  }) || ""),
      ...
      q = {
        ...
        configure: function (e) {
          if (
            e.baseUrl && "/" !== e.baseUrl.charAt(e.baseUrl.length - 1) &&
          ...
          eachProp(e, function (e, t) {
            ...
            e.packages && each(e.packages, function (e) {
              ...
              t = (e = "string" == typeof e ? { name: e } : e).name,
                ...
                y.pkgs[t] = e.name + "/" +
                  (e.main || "main").replace(currDirRegExp, "").replace(
                    jsSuffixRegExp,
                    "",
                  );
            }),
        ...
        makeRequire: function (t, n) {
          function o(i, r, u) {
            var d, p, f;
            return n.enableBuildCallback && r && isFunction(r) &&
        ...
        completeLoad: function (e) {
          ...
          if (
            ...
            if (!(!y.enforceDefine || a && getGlobal(a))) {
              return n(e) ? void 0
              : c(makeError("nodefine", "No define call for " + e, null, [e]));
            }
  ...
  var req,
    ...
    readyRegExp = isBrowser && "PLAYSTATION 3" === navigator.platform
      ...
      : /^(complete|loaded)$/,
    defContextName = "_",
    isOpera = "undefined" != typeof opera &&
  ...
  if (void 0 === define) {
    ...
    (cfg = require, require = void 0),
      req = requirejs = function (e, t, i, r) {
        ...
        return isArray(e) || "string" == typeof e ||
      ...
      req.load = function (e, t, i) {
        var r, n = e && e.config || {};
        if (isBrowser) {
          return (r = req.createNode(n, t, i)).setAttribute(
            "data-requirecontext",
            e.contextName,
          ),
      ...
      define = function (e, t, i) {
        ...
        "string" != typeof e && (i = t, t = e, e = null),
          ...
          (t = [],
            i.length &&
            (i.toString().replace(commentRegExp, commentReplace).replace(
              cjsRequireRegExp,
              function (e, i) {
                t.push(i);
              },
              ...
              t = (1 === i.length
                ? ["require"]
                : ["require", "exports", "module"]).concat(t))),
          useInteractive &&
